...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HPR2_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HPR2_HPP
...
inline void hpr2( const Order order, const UpLo uplo, const int n,
    ...
    cublasSspr2( blas::detail::blas_option< UpLo >::value, n, alpha, x, incx, y, incy, ap );
}
