...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HEMV_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HEMV_HPP
...
inline void hemv( const Order order, const UpLo uplo, const int n,
    ...
    cublasSsymv( blas::detail::blas_option< UpLo >::value, n, alpha, a, lda, x, incx, beta,
            y, incy );
}
