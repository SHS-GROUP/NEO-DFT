...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TBSV_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TBSV_HPP
...
inline void tbsv( const Order order, const UpLo uplo, const Trans trans,
    ...
    cublasStbsv( blas::detail::blas_option< UpLo >::value, blas::detail::blas_option< Trans >::value,
            blas::detail::blas_option< Diag >::value, n, k, a, lda, x, incx );
}
