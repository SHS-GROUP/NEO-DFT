...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TRMV_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TRMV_HPP
...
inline void trmv( const Order order, const UpLo uplo, const Trans trans,
    ...
    cublasStrmv( blas::detail::blas_option< UpLo >::value, blas::detail::blas_option< Trans >::value,
