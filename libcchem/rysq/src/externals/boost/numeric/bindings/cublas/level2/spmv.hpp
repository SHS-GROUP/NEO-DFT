...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_SPMV_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_SPMV_HPP
...
inline void spmv( const Order order, const UpLo uplo, const int n,
    ...
    cublasSspmv( blas::detail::blas_option< UpLo >::value, n, alpha, ap, x, incx, beta, y,
            incy );
}
