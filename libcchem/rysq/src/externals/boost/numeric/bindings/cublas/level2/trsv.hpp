...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TRSV_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TRSV_HPP
...
inline void trsv( const Order order, const UpLo uplo, const Trans trans,
    ...
    cublasStrsv( blas::detail::blas_option< UpLo >::value, blas::detail::blas_option< Trans >::value,
            blas::detail::blas_option< Diag >::value, n, a, lda, x, incx );
}
...
inline void trsv( const Order order, const UpLo uplo, const Trans trans,
        ...
        double* x, const int incx ) {
    BOOST_STATIC_ASSERT( (is_same<Order, tag::column_major>::value) );
    cublasDtrsv( blas::detail::blas_option< UpLo >::value, blas::detail::blas_option< Trans >::value,
            blas::detail::blas_option< Diag >::value, n, a, lda, x, incx );
}
