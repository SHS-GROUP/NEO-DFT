...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL3_SYRK_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL3_SYRK_HPP
...
inline void syrk( const Order order, const UpLo uplo, const Trans trans,
    ...
    cublasSsyrk( blas::detail::blas_option< UpLo >::value, blas::detail::blas_option< Trans >::value, n,
...
inline void syrk( const Order order, const UpLo uplo, const Trans trans,
        ...
        const int lda, const double beta, double* c, const int ldc ) {
    BOOST_STATIC_ASSERT( (is_same<Order, tag::column_major>::value) );
    cublasDsyrk( blas::detail::blas_option< UpLo >::value, blas::detail::blas_option< Trans >::value, n,
            k, alpha, a, lda, beta, c, ldc );
}
