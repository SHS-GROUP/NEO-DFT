...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TBMV_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TBMV_HPP
...
inline void tbmv( const Order order, const UpLo uplo, const Trans trans,
    ...
    cublasStbmv( blas::detail::blas_option< UpLo >::value, blas::detail::blas_option< Trans >::value,
