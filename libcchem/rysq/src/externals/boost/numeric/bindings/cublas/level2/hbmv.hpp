...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HBMV_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HBMV_HPP
...
inline void hbmv( const Order order, const UpLo uplo, const int n,
    ...
    cublasSsbmv( blas::detail::blas_option< UpLo >::value, n, k, alpha, a, lda, x, incx,
            beta, y, incy );
}
