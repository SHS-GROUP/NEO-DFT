...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL3_TRSM_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL3_TRSM_HPP
...
inline void trsm( const Order order, const Side side, const UpLo uplo,
    ...
    cublasStrsm( blas::detail::blas_option< Side >::value, blas::detail::blas_option< UpLo >::value,
...
inline void trsm( const Order order, const Side side, const UpLo uplo,
        ...
        const int ldb ) {
    BOOST_STATIC_ASSERT( (is_same<Order, tag::column_major>::value) );
    cublasDtrsm( blas::detail::blas_option< Side >::value, blas::detail::blas_option< UpLo >::value,
            blas::detail::blas_option< TransA >::value, blas::detail::blas_option< Diag >::value, m, n,
            alpha, a, lda, b, ldb );
}
