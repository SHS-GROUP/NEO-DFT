...
#include <boost/numeric/bindings/traits/ublas_transpose.hpp>
...
namespace traits {
	...
	typedef typename mpl::if_<
	    ...
	    const typename expression_type::ublas_base,
	    typename expression_type::ublas_base
	    >::type ublas_base;
		
	typedef matrix_detail_traits<
	    typename E::ublas_base, ublas_base> base;
