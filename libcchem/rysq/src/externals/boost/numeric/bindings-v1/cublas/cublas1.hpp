...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_CUBLAS1_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_CUBLAS1_HPP

#include <boost/numeric/bindings/cublas/forward.hpp>
#include <boost/numeric/bindings/cublas/cublas1_overloads.hpp>
...
namespace cublas {
  ...
  void copy(const cublas::vector_expression<X> &x,
	    cublas::vector_expression<Y> &y ) {
#ifndef BOOST_NUMERIC_BINDINGS_POOR_MANS_TRAITS
    BOOST_STATIC_ASSERT((boost::is_same<
			 typename traits::vector_traits<X>::value_type,
			 typename traits::vector_traits<Y>::value_type>::value));
#else
    BOOST_STATIC_ASSERT((boost::is_same<
...
#endif // BOOST_NUMERIC_BINDINGS_CUBLAS_CUBLAS1_HPP
