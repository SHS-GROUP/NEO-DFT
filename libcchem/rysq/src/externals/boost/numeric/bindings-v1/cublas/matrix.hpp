...
namespace cublas {
	...
	// typedef ublas::matrix_expression<typename E::ublas_type> ublas_type;
	...
	template< class> friend class ublas::matrix_row;
	template< class> friend class ublas::matrix_column;
	...
	matrix_base<M, ublas::matrix_range<M> >
    {
	typedef ublas::matrix_range<M> ublas_base;
	typedef matrix_base<M, ublas_base> base;
    ...
    template<class M>
    matrix_range<M> submatrix(M &m, range r1, range r2) {
