...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL1_ASUM_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL1_ASUM_HPP
...
// * float value-type.
//
inline float asum( cublasHandle_t handle, const int n, const float* x, const int incx ) {
    return cublasSasum( handle, n, x, incx );
}
...
// * double value-type.
//
inline double asum( cublasHandle_t handle, const int n, const double* x, const int incx ) {
    return cublasDasum( handle, n, x, incx );
}
...
// * complex<float> value-type.
//
inline float asum( cublasHandle_t handle, const int n, const std::complex<float>* x,
        const int incx ) {
    return (throw std::runtime_error(std::string(__FILE__) + ":not implemented"), 0);;
}
...
// * complex<double> value-type.
//
inline double asum( cublasHandle_t handle, const int n, const std::complex<double>* x,
        const int incx ) {
    return (throw std::runtime_error(std::string(__FILE__) + ":not implemented"), 0);;;
}
