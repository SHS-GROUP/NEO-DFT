...
inline void gemm( const Order order, const TransA transa, const TransB transb,
    ...
    cublasSgemm( blas::detail::blas_option< TransA >::value, blas::detail::blas_option< TransB >::value,
...
inline void gemm( const Order order, const TransA transa, const TransB transb,
        ...
        const double beta, double* c, const int ldc ) {
    BOOST_STATIC_ASSERT( (is_same<Order, tag::column_major>::value) );
    cublasDgemm( blas::detail::blas_option< TransA >::value, blas::detail::blas_option< TransB >::value,
            m, n, k, alpha, a, lda, b, ldb, beta, c, ldc );
}
