...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL3_HER2K_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL3_HER2K_HPP
...
inline void her2k( const Order order, const UpLo uplo, const Trans trans,
    ...
    cublasSsyr2k( blas::detail::blas_option< UpLo >::value, blas::detail::blas_option< Trans >::value, n,
...
inline void her2k( const Order order, const UpLo uplo, const Trans trans,
        ...
        double* c, const int ldc ) {
    BOOST_STATIC_ASSERT( (is_same<Order, tag::column_major>::value) );
    cublasDsyr2k( blas::detail::blas_option< UpLo >::value, blas::detail::blas_option< Trans >::value, n,
            k, alpha, a, lda, b, ldb, beta, c, ldc );
}
