...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HPR_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HPR_HPP
...
inline void hpr( const Order order, const UpLo uplo, const int n,
    ...
    cublasSspr( blas::detail::blas_option< UpLo >::value, n, alpha, x, incx, ap );
}
