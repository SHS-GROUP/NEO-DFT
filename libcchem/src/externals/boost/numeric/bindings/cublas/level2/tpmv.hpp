...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TPMV_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TPMV_HPP
...
inline void tpmv( const Order order, const UpLo uplo, const Trans trans,
    ...
    cublasStpmv( blas::detail::blas_option< UpLo >::value, blas::detail::blas_option< Trans >::value,
            blas::detail::blas_option< Diag >::value, n, ap, x, incx );
}
