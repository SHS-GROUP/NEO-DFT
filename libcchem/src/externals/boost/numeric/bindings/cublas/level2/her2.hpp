...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HER2_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HER2_HPP
...
inline void her2( const Order order, const UpLo uplo, const int n,
    ...
    cublasSsyr2( blas::detail::blas_option< UpLo >::value, n, alpha, x, incx, y, incy, a,
            lda );
}
