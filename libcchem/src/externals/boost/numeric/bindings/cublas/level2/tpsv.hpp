...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TPSV_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_TPSV_HPP
...
inline void tpsv( const Order order, const UpLo uplo, const Trans trans,
    ...
    cublasStpsv( blas::detail::blas_option< UpLo >::value, blas::detail::blas_option< Trans >::value,
