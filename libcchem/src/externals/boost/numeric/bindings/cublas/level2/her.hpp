...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HER_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_HER_HPP
...
inline void her( const Order order, const UpLo uplo, const int n,
    ...
    cublasSsyr( blas::detail::blas_option< UpLo >::value, n, alpha, x, incx, a, lda );
}
...
inline void her( const Order order, const UpLo uplo, const int n,
        ...
        const int lda ) {
    BOOST_STATIC_ASSERT( (is_same<Order, tag::column_major>::value) );
    cublasDsyr( blas::detail::blas_option< UpLo >::value, n, alpha, x, incx, a, lda );
}
