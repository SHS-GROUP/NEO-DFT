...
#ifndef BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_GBMV_HPP
#define BOOST_NUMERIC_BINDINGS_CUBLAS_LEVEL2_GBMV_HPP
...
inline void gbmv( const Order order, const Trans trans, const int m,
    ...
    cublasSgbmv( blas::detail::blas_option< Trans >::value, m, n, kl, ku, alpha, a, lda, x,
            incx, beta, y, incy );
}
